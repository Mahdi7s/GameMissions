using GameMissions.Core.ContributorAggregate.Events;
using GameMissions.SharedKernel.Interfaces;
using GameMissions.Core.ProjectAggregate.Specifications;
using MediatR;

namespace GameMissions.Core.ProjectAggregate.Handlers;
